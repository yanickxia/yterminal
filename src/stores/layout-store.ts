// layout-store: persisted chrome geometry — the widths of the two side panels
// (workspace sidebar, AI sidebar) and whether the workspace sidebar is
// collapsed. Kept in one small store so App (which renders the draggable
